package com.samoylenko.homework213;
    ...
    private void initViews() {
        ...
        mBtnOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mStartDate > mEndDate){
                    ...
                    mChooseEndDate.setText(R.string.date_end);
                } else {
                    Toast.makeText(MainActivity.this, getString(R.string.result, mStartDateTxt, mEndDateTxt), Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        mStartDateCalendar.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(@NonNull CalendarView calendarView, int i, int i1, int i2) {
                ...
                mChooseStartDate.setText(getString(R.string.date_start_value, mStartDateTxt));
        ...
        mEndtDateCalendar.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(@NonNull CalendarView calendarView, int i, int i1, int i2) {
                mEndDateTxt = i+"-"+i1+"-"+i2;
                mChooseEndDate.setText(getString(R.string.date_end_value, mEndDateTxt));
                GregorianCalendar gregorianCalendar = new GregorianCalendar();
                gregorianCalendar.set(i, i1, i2);
